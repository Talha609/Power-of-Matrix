    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(r.isEmpty())
                    Toast.makeText(Activity3.this, "Please Enter All Details", Toast.LENGTH_SHORT).show();
                else {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (c.isEmpty()) {
                    Toast.makeText(Activity3.this, "Please Enter Number!!", Toast.LENGTH_SHORT).show();
                } else {
                    if (x == row - 1 && y == row) {
                        Toast.makeText(Activity3.this, "Matix Is Full!", Toast.LENGTH_SHORT).show();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tv5.getText().toString().equals("0"))
                {
                    tv6.setText("1");
                }
                else if(tv5.getText().toString().equals("1")) {
                    for (x = 0; x <= row - 1; x++)
                    {
                        for(y=0;y<=row-1;y++)
                        {
        ...
        btnclr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(Activity3.this,com.example.mohdtalha.matrixapp.MainActivity.class);
